...
export const MobileNavigation = (props: MobileNavigationProps) => {
  ...
  return (
    ...
    >
      <div data-uid="qZXgRnOqwhN1USzE" onClick={(event) => event.stopPropagation()} className={`box-border caret-transparent flex flex-col h-full justify-between min-h-[auto] min-w-[auto] outline-[3px] w-[390px] pt-20 pb-6 px-6 font-system_ui transition-[opacity,transform] duration-300 md:min-h-0 md:min-w-0 md:font-inter_v ${props.isOpen ? "opacity-100 translate-y-0" : "opacity-0 -translate-y-2"}`}>
