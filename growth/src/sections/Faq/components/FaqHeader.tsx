  ...
  return (
    <div data-uid="X0V-yqBJ63ADT4TT" className="box-border caret-transparent outline-[3px] w-[358px] mx-auto font-system_ui md:w-[744px] md:font-inter_v">
      <div data-uid="fqRdgSv9DqF-e7qA" className="box-border caret-transparent outline-[3px] mb-3 font-system_ui md:font-inter_v">
        ...
        <h2 data-uid="35VUkcOpdRRTo1HB" className="text-[28px] font-bold box-border caret-transparent leading-9 outline-[3px] text-center font-rebond_grotesque md:text-[56px] md:leading-[64px]">
          <span data-uid="MiJhfV7_OUx1u4m3" className="text-transparent text-[28px] bg-clip-text bg-[linear-gradient(rgb(255,255,255)_22.5%,rgba(255,255,255,0.7)_100%)] box-border block leading-9 outline-[3px] md:text-[56px] md:leading-[64px]">
            Frequently asked questions
          </span>
        </h2>
      </div>
      <p data-uid="UdC3vZTXxK81nzUu" className="text-gray-400 text-base font-medium box-border caret-transparent tracking-[-0.16px] leading-6 max-w-[300px] outline-[3px] text-center mx-auto font-system_ui md:text-xl md:tracking-[-0.4px] md:leading-7 md:max-w-none md:font-inter_v">
