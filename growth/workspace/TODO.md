...
<todo id="wire-real-navigation-routes">
Wire real routes for nav and footer links
Pricing, download, and authentication paths still need product pages; landing-page CTAs now use valid in-page anchors.
</todo>

<todo id="replace-external-asset-dependencies">
Replace fragile external hosted image assets
Move critical visuals to stable project assets to prevent future broken renders and improve load reliability.
</todo>
